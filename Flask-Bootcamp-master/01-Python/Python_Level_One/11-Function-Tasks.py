...
def seq_check(nums):
    # Code here
            return True if '123' in ''.join([str(n) for n in nums]) else False

print(seq_check([1, 2, 4]))
print(seq_check([1, 2, 3]))

# return True if str([n for n in [1, 2, 3]) in str(nums) else False
...
print(compare_len('hello', 'worldo'))
